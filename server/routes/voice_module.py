...
async def voice(data: dict, module: str, call_variables: str, event: str, channel_id: str, number: str, spoof: str, service: str, name: str, otpdigits: str, chatid: str, tag: str):
    if event == "Dial":
        # CHANGE CALL STARTED TO YES
        info = await fetch_calldetails(channel_id=channel_id)
        if info.get('is_dial_ran') != "yes":
            print("RUNNING DIAL HANDLE COMMAND!!!!!!!!!!!!!")
